...
| The poster could have included the features more clearly with details. As of now, I am unable to obtain much information from the poster without reading the README. | Our updated poster has been reformatted such that there are more details and information on what this game is about. |
...
| It would be great if we could actually see a working demonstration of the game instead. | As provided since the very first milestone, we have always uploaded a playable version of our game. Also, we encourage all to play through it to have a better understanding of out project. |
...
| Unit testing can be done to ensure that all the controls and the game mechanisms are working correctly. | We have implemented suer testing leading to milestone 3 to further improve on the game mechanics. |
