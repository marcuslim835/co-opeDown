...
| 30  | Work from Home: Project Video, Poster, Log, and Readme                     | 24/7/2021 - 26/7/2021 | 9               | 9               | 1) Tidy up project log <br> 2) Update readme with testing information <br> 3) Update project video with gameplay |
...
| Some things to take note are that if you do want to make players play through the same levels again and again, try and add some more variety, maybe more stages etc.  | We have since added varying difficulties and obstacles so that it does not feel repetitive. |
