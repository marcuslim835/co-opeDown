...
public class TrivialQuestionsStage2 : MonoBehaviour
{
    ...
    private string[,] playerQuestions = new string[8, 4] {
        {"Player 1's favourite parent is", "Mummy", "Daddy", "Don't Know"},
        {"Player 1's favourite drink is", "Gasy drinks", "Bubble tea", "Plain Water"},
        {"Player 1 is", "Always late", "Punctual", "Forgetful" },
        {"Player 1's favourite parent is", "Mummy", "Daddy", "Don't Know"},
        {"Player 2's favourite drink is", "Gasy drinks", "Bubble tea", "Plain Water"},
        {"Player 2 is", "good with words", "bad at explaining", "talkative" },
        {"Player 1 is", "good with words", "bad at explaining", "talkative" },
        {"Player 2 is", "Always late", "Punctual", "Forgetful" }
    };
