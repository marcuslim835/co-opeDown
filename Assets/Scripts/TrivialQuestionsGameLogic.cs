...
public class TrivialQuestionsGameLogic : MonoBehaviour
{
    ...
    private string[,] playerQuestions = new string[8, 4] {
        {"Player 1's favourite cuisine", "Japanese", "Chinese", "Indian"},
        {"Player 1's favourite subject", "Math", "Science", "History"},
        {"Player 1 is", "patient", "kind", "disorganised" },
        {"Player 2's favourite cuisine", "Japanese", "Chinese", "Indian"},
        {"Player 2's favourite subject", "Math", "Science", "History"},
        {"Player 2 is", "patient", "kind", "disorganised" },
        {"Player 1 is punctual", "True", "Somewhat true", "False" },
        {"Player 2 is punctual", "True", "Somewhat true", "False" }
    };
