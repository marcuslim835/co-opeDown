...
public class TrivialQuestionsStage3 : MonoBehaviour
{
    ...
    private string[,] playerQuestions = new string[8, 4] {
        {"Does Player 1 have something to tell Player 2", "Yes", "No", "Don't Know"},
        {"Player 1 just told a lie", "Yes", "No", "Secret"},
        {"Player 1 is", "Trying to \n be better", "Hoping for \n better days", "Gonna achieve \n great things" },
        {"Player 1 is", "putting effort \n to improve things", "not trying", "lost" },
        {"Does Player 2 have something to tell Player 1", "Yes", "No", "Don't Know"},
        {"Player 2 just told a lie", "Yes", "No", "Secret"},
        {"Player 2 is", "putting effort \n to improve things", "not trying", "lost" },
